...
②スライドショーの写真から購入できるようにした

過去に、自身がECサイトを利用した際に、スライドショーの写真の商品が気に入ってスライドショーをクリックしても、その商品とは関係のないページに遷移してしまい、欲しいと思った商品の購入に辿り着けなかった経験があった。 そこで、スライドショーの写真からも購入できるようにしたいと考えていたためこのような仕様とした。
