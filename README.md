...
# アプリケーションを作成した背景
漆芸家、画家の義父が漆を使い作ったアクセサリーや水彩画などを展示・販売する展覧会を時行っているが頻繁にはできない。出展料がかかる。場所時間が限られる。準備が大変という課題がありオンラインで作品の展示・販売ができるECサイトを作成した
...
* スライドショーを用いることで作品を全面に表示し華やかに見せるようにした
* スライドショーの写真の商品が気に入って購入したいと思いスライドショーをクリックしてもその商品とは関係のないページに遷移してしまい、欲しいと思った商品の購入に辿り着けなかった自身の経験があり、スライドショーの写真からも購入できるようにしたいと考えていたためこのような仕様にした
